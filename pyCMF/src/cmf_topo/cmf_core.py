...
class WaterStorage(StateVariable,StateVariableOwner,FluxNode):
    ...
    def __str__(self):
        """__str__(self) -> string"""
        return _cmf_core.WaterStorage___str__(self)
...
WaterStorage.__str__ = new_instancemethod(_cmf_core.WaterStorage___str__,None,WaterStorage)
...
class Reach(object):
    ...
    def __repr__(self):
        return "A reach (node #%i) at %s" % (self.node_id,self.cell)
