...
class VGM_BC_RetentionCurve_Windhorst(VanGenuchtenMualem):
    r"""Proxy of C++ cmf::upslope::VGM_BC_RetentionCurve_Windhorst class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    eta = property(_cmf_core.VGM_BC_RetentionCurve_Windhorst_eta_get, _cmf_core.VGM_BC_RetentionCurve_Windhorst_eta_set, doc=r"""eta : real""")
    copy = _swig_new_instance_method(_cmf_core.VGM_BC_RetentionCurve_Windhorst_copy)

    def __init__(self, *args, **kwargs):
        r"""__init__(VGM_BC_RetentionCurve_Windhorst self, real Ksat=15, real phi=0.5, real alpha=0.2178, real n=1.211, real m=-1, real eta=9.14) -> VGM_BC_RetentionCurve_Windhorst"""
...
# Register VGM_BC_RetentionCurve_Windhorst in _cmf_core:
_cmf_core.VGM_BC_RetentionCurve_Windhorst_swigregister(VGM_BC_RetentionCurve_Windhorst)
