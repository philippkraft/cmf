...
class PredictCorrectSimple(Integrator):
    ...
    def __init__(self, *args): 
        """
        __init__(self, StateVariableOwner states, real Alpha = 0.5) -> PredictCorrectSimple
...
class Cell(StateVariableOwner):
    ...
    def add_storage(self, *args):
        ...
        add_storage(self, ptr storage) -> int
