...
vector_int_swigregister = _cmf_core.vector_int_swigregister
...
vector_double_swigregister = _cmf_core.vector_double_swigregister
...
vector_size_t_swigregister = _cmf_core.vector_size_t_swigregister
...
sparse_structure_swigregister = _cmf_core.sparse_structure_swigregister
sparse_structure_swigregister(sparse_structure)
...
CVodeKLU_swigregister = _cmf_core.CVodeKLU_swigregister
CVodeKLU_swigregister(CVodeKLU)
...
CrossSectionReach_swigregister = _cmf_core.CrossSectionReach_swigregister
CrossSectionReach_swigregister(CrossSectionReach)
...
def ShuttleworthWallace_use_for_cell(*args, **kwargs):
    """ShuttleworthWallace_use_for_cell(Cell cell) -> cmf::upslope::ET::ShuttleworthWallace::ptr"""
    return _cmf_core.ShuttleworthWallace_use_for_cell(*args, **kwargs)
...
SW_transpiration_swigregister = _cmf_core.SW_transpiration_swigregister
SW_transpiration_swigregister(SW_transpiration)
...
SW_evap_from_layer_swigregister = _cmf_core.SW_evap_from_layer_swigregister
SW_evap_from_layer_swigregister(SW_evap_from_layer)
...
SW_evap_from_canopy_swigregister = _cmf_core.SW_evap_from_canopy_swigregister
SW_evap_from_canopy_swigregister(SW_evap_from_canopy)
...
SW_evap_from_snow_swigregister = _cmf_core.SW_evap_from_snow_swigregister
SW_evap_from_snow_swigregister(SW_evap_from_snow)
...
SW_evap_from_surfacewater_swigregister = _cmf_core.SW_evap_from_surfacewater_swigregister
SW_evap_from_surfacewater_swigregister(SW_evap_from_surfacewater)
