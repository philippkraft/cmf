@page CmfTutFirstModel.md

@tableofcontents

 [index...](CmfTutStart.md)
[next...](CmfTutBoundary.md)
...
can be queried (see [Query fluxes and storages](CmfTutFluxes.md)) and,
...
Next step is to include [boundary conditions](CmfTutBoundary.md).
