...
def create_hillslope(subsurface_lateral_connection,
    ...
    :param subsurface_lateral_connection: The type of the lateral connection for the subsurface
    :param surface_lateral_connection: The type of the lateral connection at the surface
    :param cellcount: Number of cells
    :param celllength: x dimension of cell
    :param form: The y form of the hillslope S, D, or C
